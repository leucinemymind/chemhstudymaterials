...
$$\text{Cu}^{2+} + 2e^- \longrightarrow \text{Cu} \: (0.34 V)$$
$$\text{Zn}^{2+} + 2e^- \longrightarrow \text{Zn} \: (-0.726 V)$$

Flip the equation that is higher on the standard reduction potential table:

$$\text{Cu}^{2+} + 2e^- \longrightarrow \text{Cu} \: (0.34 V)$$
$$\text{Zn} \longrightarrow \text{Zn}^{2+} + 2e^- \: (0.726 V)$$

Combine:

$$\boxed{\text{Cu}^{2+} + \text{Zn} \longrightarrow \text{Cu} + \text{Zn}^{2+}}$$
