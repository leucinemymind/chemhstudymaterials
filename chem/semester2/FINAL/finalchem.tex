...
The \textbf{half-life} of a radioisotope sample is the amount of time it takes for 50\% of it to decay. Every isotope has its own half-life that does not change. The amount of sample follows an exponential decay model that approaches 0 asymptotically.
